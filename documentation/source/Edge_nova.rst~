...
get_fraction(pos)
++++++++++++++++++
**Parâmetro: pos** -	PySide.QtCore.qreal

Esta função obtém uma fração da linha e é utilizada durante o modelo que denomino "Sticky to Line" de um nó de carga. Pode ser usado para outros fins em futuras expansões.
...
**Parâmetro: - event** -QtCore.QPointF
